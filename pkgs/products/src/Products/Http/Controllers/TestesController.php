...
namespace Satelite\ProductsHttp\Controllers;
...
use Satelite\Http\Requests\TesteCreateRequest;
use Satelite\Http\Requests\TesteUpdateRequest;
...
class TestesController extends Controller
{
    ...
    public function update(TesteUpdateRequest $request, $id)
    {
        ...
        try {
            ...
            $teste = $this->repository->update($id, $request->all());
